...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2020 at 06:32 AM
...
--
CREATE DATABASE IF NOT EXISTS `retaildb_mysql` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `retaildb_mysql`;
...
INSERT INTO `categorylist` (`CategoryID`, `CategoryName`, `Description`) VALUES
...
INSERT INTO `customerlist` (`CustomerID`, `CustomerName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`) VALUES
...
INSERT INTO `employeelist` (`EmployeeID`, `LastName`, `FirstName`, `BirthDate`, `Photo`, `Notes`) VALUES
...
(2, 'Fuller', 'Andrew', ' ', 'EmpID2.pic', 'Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then '),
...
(5, 'Buchanan', 'Steven', '3/4/1955', 'EmpID5.pic', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in Londo'),
(6, 'Suyama', 'Michael', '7/2/1963', 'EmpID6.pic', 'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses \'Multi-Cultural Selling\' and \'Time Management for the Sales Professional\'. He is fluent in Japa'),
(7, 'King', 'Robert', '5/29/1960', 'EmpID7.pic', 'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled \'Selling in Europe\', he was transferred to the Londo'),
...
INSERT INTO `orderlist` (`OrderID`, `CustomerID`, `EmployeeID`, `OrderDate`, `ShipperID`) VALUES
...
INSERT INTO `productlist` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `Unit`, `Price`) VALUES
...
(29, 'Thüringer Rostbratwurst', 12, 6, '50 bags x 30 sausgs.', '99.99'),
...
(38, 'Côte de Blaye', 18, 1, '12 - 75 cl bottles', '99.99'),
...
--
-- Table structure for table `shipperlist`
--

CREATE TABLE `shipperlist` (
  `ShipperID` int(2) NOT NULL,
...
--
-- Dumping data for table `shipperlist`
--

INSERT INTO `shipperlist` (`ShipperID`, `ShipperName`, `Phone`) VALUES
...
CREATE TABLE `supplierlist` (
  `SupplierID` int(3) NOT NULL,
  `SupplierName` varchar(155) NOT NULL,
  `ContactName` varchar(64) NOT NULL,
  `Address` varchar(155) NOT NULL,
  `City` varchar(155) NOT NULL,
  `PostalCode` varchar(32) NOT NULL,
...
INSERT INTO `supplierlist` (`SupplierID`, `SupplierName`, `ContactName`, `Address`, `City`, `PostalCode`, `Country`, `Phone`) VALUES
...
--
-- Indexes for table `shipperlist`
--
ALTER TABLE `shipperlist`
...
--
ALTER TABLE `categorylist`
  MODIFY `CategoryID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `orderdetails`
  MODIFY `OrderDetailID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=519;

--
-- AUTO_INCREMENT for table `orderlist`
--
ALTER TABLE `orderlist`
  MODIFY `OrderID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10444;

--
-- AUTO_INCREMENT for table `productlist`
--
ALTER TABLE `productlist`
  MODIFY `ProductID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `shipperlist`
--
ALTER TABLE `shipperlist`
  MODIFY `ShipperID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `supplierlist`
--
ALTER TABLE `supplierlist`
  MODIFY `SupplierID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
COMMIT;
